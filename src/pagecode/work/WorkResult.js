...
import { Grid, Button, Header, Container, Divider, Table } from 'semantic-ui-react'
import WorkResultStep from './components/WorkResultStep';
  ...
  return (
    <Container>
      ...
      <Grid textAlign='center' style={{ padding: '40px' }}>
        <Button primary size='big' as={Link} to="/work">再新增一筆</Button>
        < ReactToPrint
          trigger={() => <Button size='big' color='red'>列印維修單</Button>}
